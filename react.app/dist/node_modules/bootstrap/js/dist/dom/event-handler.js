...
(function (global, factory) {
  ...
  function removeNamespacedHandlers(element, events, typeEvent, namespace) {
    ...
    try {
      for (var _iterator2 = Object.keys(storeElementEvent)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var handlerKey = _step2.value;
  ...
  var EventHandler = {
    ...
    off: function off(element, originalTypeEvent, handler, delegationFunction) {
      ...
      try {
        for (var _iterator4 = Object.keys(storeElementEvent)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var keyHandlers = _step4.value;
