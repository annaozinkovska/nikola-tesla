...
(function (global, factory) {
  ...
  var Carousel = function (_BaseComponent__defau) {
    ...
    _createClass(Carousel, [{
      ...
      value: function _addTouchEventListeners() {
        ...
        try {
          for (var _iterator = SelectorEngine__default.default.find(SELECTOR_ITEM_IMG, this._element)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var img = _step.value;
      ...
      value: function _setActiveIndicatorElement(index) {
        ...
        var newActiveIndicator = SelectorEngine__default.default.findOne('[data-bs-slide-to="' + index + '"]', this._indicatorsElement);
