...
var Offcanvas = function (_BaseComponent) {
  ...
  _createClass(Offcanvas, [{
    ...
    value: function show(relatedTarget) {
      ...
      var showEvent = EventHandler.trigger(this._element, EVENT_SHOW, { relatedTarget: relatedTarget });
      ...
      var completeCallBack = function completeCallBack() {
        ...
        EventHandler.trigger(_this2._element, EVENT_SHOWN, { relatedTarget: relatedTarget });
      };
