...
function createInvalidArgumentTypeError(message, argument, expected) {
  ...
  err.actual = typeof argument === 'undefined' ? 'undefined' : _typeof(argument);
  return err;
}
...
function createInvalidExceptionError(message, value) {
  ...
  err.valueType = typeof value === 'undefined' ? 'undefined' : _typeof(value);
  err.value = value;
  return err;
}
...
function createInvalidPluginError() {
  ...
  return createInvalidLegacyPluginError.apply(undefined, arguments);
}
...
function createMultipleDoneError(runnable, originalErr) {
  ...
  err.valueType = typeof originalErr === 'undefined' ? 'undefined' : _typeof(originalErr);
...
var isMochaError = function isMochaError(err) {
  return Boolean(err && (typeof err === 'undefined' ? 'undefined' : _typeof(err)) === 'object' && MOCHA_ERRORS.has(err.code));
};
