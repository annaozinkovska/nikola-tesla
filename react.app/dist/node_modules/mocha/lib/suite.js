...
var _require2 = require('./utils'),
    ...
    defineConstants = _require2.defineConstants,
...
function Suite(title, parentContext, isRoot) {
  if (!isString(title)) {
    throw errors.createInvalidArgumentTypeError('Suite argument "title" must be a string. Received type "' + (typeof title === 'undefined' ? 'undefined' : _typeof(title)) + '"', 'title', 'string');
  }
  this.title = title;
  function Context() {}
