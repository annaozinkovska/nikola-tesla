...
minimatch.defaults = function (def) {
  if (!def || (typeof def === 'undefined' ? 'undefined' : _typeof(def)) !== 'object' || !Object.keys(def).length) {
    return minimatch;
  }
  ...
  m.Minimatch = function (_orig$Minimatch) {
    _inherits(Minimatch, _orig$Minimatch);

    function Minimatch(pattern, options) {
      _classCallCheck(this, Minimatch);

      return _possibleConstructorReturn(this, (Minimatch.__proto__ || Object.getPrototypeOf(Minimatch)).call(this, pattern, ext(def, options)));
    }
...
var _braceExpand = function _braceExpand(pattern) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _createClass(Minimatch, [{
    ...
    value: function make() {
      ...
      set = set.map(function (s, si, set) {
        return s.map(_this2.parse, _this2);
      });
    ...
    value: function parse(pattern, isSub) {
      ...
      var clearStateChar = function clearStateChar() {
        if (stateChar) {
          ...
          _this3.debug('clearStateChar %j %j', stateChar, re);
          stateChar = false;
        }
      };
