...
var toRegexRange = function toRegexRange(min, max, options) {
  ...
  var opts = Object.assign({ relaxZeros: true }, options);
...
function splitToRanges(min, max) {
  ...
  stops = [].concat(_toConsumableArray(stops));
  stops.sort(compare);
  return stops;
}
...
function toQuantifier(digits) {
  var _digits = _slicedToArray(digits, 2),
      _digits$ = _digits[0],
      start = _digits$ === undefined ? 0 : _digits$,
      _digits$2 = _digits[1],
      stop = _digits$2 === undefined ? '' : _digits$2;
