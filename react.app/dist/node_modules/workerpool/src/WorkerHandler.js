...
function tryRequireWorkerThreads() {
  try {
    ...
    if ((typeof error === 'undefined' ? 'undefined' : _typeof(error)) === 'object' && error !== null && error.code === 'MODULE_NOT_FOUND') {
...
function WorkerHandler(script, _options) {
  ...
  function dispatchQueuedRequests() {
    ...
    try {
      for (var _iterator = me.requestQueue.splice(0)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
