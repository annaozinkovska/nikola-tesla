...
var mixin = void 0;
export var YargsParser = function () {
    ...
    _createClass(YargsParser, [{
        ...
        value: function parse(argsInput, options) {
            ...
            [].concat(opts.array || []).filter(Boolean).forEach(function (opt) {
                var key = (typeof opt === 'undefined' ? 'undefined' : _typeof(opt)) === 'object' ? opt.key : opt;
            ...
            checkConfiguration();
            var notFlags = [];
            var argv = Object.assign(Object.create(null), { _: [] });
            ...
            function maybeCoerceNumber(key, value) {
                ...
                if (!checkAllAliases(key, flags.strings) && !checkAllAliases(key, flags.bools) && !Array.isArray(value)) {
                    var shouldCoerceNumber = looksLikeNumber(value) && configuration['parse-numbers'] && Number.isSafeInteger(Math.floor(parseFloat('' + value)));
            ...
            function setConfigObject(config, prev) {
                Object.keys(config).forEach(function (key) {
                    ...
                    if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && value !== null && !Array.isArray(value) && configuration['dot-notation']) {
            ...
            function hasKey(obj, keys) {
                ...
                if ((typeof o === 'undefined' ? 'undefined' : _typeof(o)) !== 'object') return false;else return key in o;
            }
            function setKey(obj, keys, value) {
                ...
                keys.slice(0, -1).forEach(function (key) {
                    ...
                    key = sanitizeKey(key);
                    if ((typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' && o[key] === undefined) {
                        o[key] = {};
                    }
            ...
            function hasFlagsMatching(arg) {
                ...
                for (var _len2 = arguments.length, patterns = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
