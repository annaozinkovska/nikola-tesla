...
var picomatch = function picomatch(glob, options) {
  ...
  if (opts.ignore) {
    var ignoreOpts = Object.assign({}, options, { ignore: null, onMatch: null, onResult: null });
  ...
  var matcher = function matcher(input) {
    ...
    var _picomatch$test = picomatch.test(input, regex, options, { glob: glob, posix: posix }),
